  ...
  <div class="container mx-auto flex justify-center">
    <form method="POST" onsubmit="ArticleSave__submitForm(this); return false;" class="w-[800px]">
      ...
      <div class="flex flex-col gap-y-2 mt-3">
        ...
        <div>
          <textarea class="textarea textarea-bordered w-full" name="content" placeholder="내용을 입력해주세요." cols="30" rows="10"></textarea>
        </div>
      </div>

      <div class="btn-group w-full flex gap-x-2">
        <button type="submit" class="btn btn-outline btn-primary flex-1">작성</button>
